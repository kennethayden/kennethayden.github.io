...
This project characterized methane-hydrogen combustion in a research engine with a transparent combustion chamber that lets a high-speed camera record the flame directly as it develops. We ran fuel mixtures across a range of hydrogen fractions and air-fuel ratios, and developed routines to process the raw cylinder pressure traces and high-speed footage into the parameters that characterize engine performance. Flame color and propagation were analyzed in conjuction to connect what the combustion looked like to what the sensors measured.
...
<table width="100%">
  <tr>
    <td width="50%" valign="top">
      <h4>Pure methane:</h4>
      <video src="https://github.com/user-attachments/assets/1bb57fee-62fc-4eb0-9dc6-65c5d7f1e29f" controls width="100%">
      Your browser does not support the video tag.
      </video>
    </td>
  <td width="50%" valign="top">
      <h4>Hydrogen content 20%:</h4>
      <video src="https://github.com/user-attachments/assets/6228793b-fd80-4ddd-bb51-4f1dd0158abc" controls width="100%">
      Your browser does not support the video tag.
      </video>
    </td>
  </tr>
